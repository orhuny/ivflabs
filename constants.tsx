...
export const BLOG_POSTS: BlogPost[] = [
  {
    id: 'egg-donation-process-guide',
    title: {
      en: 'Egg Donation Step by Step: The 6 Stages of Your Treatment Journey',
      tr: 'Adım Adım Yumurta Donasyonu: Tedavi Yolculuğunuzun 6 Aşaması',
      de: 'Eizellspende Schritt für Schritt: Die 6 Etappen Ihrer Behandlungsreise',
      ru: 'Донорство яйцеклеток шаг за шагом: 6 этапов вашего лечения',
      ar: 'التبرع بالبويضات خطوة بخطوة: المراحل الست لرحلة علاجك'
    },
    excerpt: {
      en: 'From the first diagnosis to the pregnancy test on day 12 after transfer: what happens at each stage of egg donation treatment, how long it takes and when you need to travel to Cyprus.',
      tr: 'İlk teşhisten transfer sonrası 12. gündeki gebelik testine kadar: yumurta donasyonu tedavisinin her aşamasında neler yaşanır, ne kadar sürer ve Kıbrıs\'a ne zaman gelmeniz gerekir?',
      de: 'Von der ersten Diagnose bis zum Schwangerschaftstest am 12. Tag nach dem Transfer: Was in jeder Phase der Eizellspende-Behandlung geschieht und wann Sie nach Zypern reisen müssen.',
      ru: 'От первого диагноза до теста на беременность на 12-й день после переноса: что происходит на каждом этапе лечения и когда нужно приехать на Кипр.',
      ar: 'من التشخيص الأول إلى اختبار الحمل في اليوم الثاني عشر بعد النقل: ما يحدث في كل مرحلة من مراحل العلاج ومتى تحتاجين للسفر إلى قبرص.'
    },
    content: {
      en: 'Many couples who come to us have one main question: "What exactly will happen, and when?" Below you will find the six stages of egg donation treatment at Doğuş IVF Center, in the order they actually happen — so you can plan your treatment and your trip to Cyprus with confidence.\n\nSTAGE 1 — Confirming the diagnosis: The starting point of egg donation treatment is the medical finding that the mother candidate\'s own egg reserve is depleted. This is confirmed with hormone tests (such as AMH and FSH) and an ultrasound assessment. If you already have recent test results, our doctors can review them remotely before you travel.\n\nSTAGE 2 — Tests for both partners, and donor selection at the same time: While the mother and father candidates complete their required tests and reports, we simultaneously begin selecting and preparing a suitable donor from our pool. Donors are matched by physical characteristics and blood type, and every donor goes through detailed medical and genetic screening. Running these two steps in parallel is what keeps the overall timeline short.\n\nSTAGE 3 — Preparing the uterus and stimulating the donor: On one side, the mother candidate\'s uterus is prepared for embryo transfer with a simple medication protocol that can be followed in her home country. On the other side, the selected donor completes her final examinations and begins the stimulation that allows her egg cells to develop.\n\nSTAGE 4 — Setting the start date and inviting you to our center: Once both preparations are aligned, we confirm the exact start date of the procedures and invite the family to our center in Nicosia. Most patients only need to be physically in Cyprus for this final part of the treatment.\n\nSTAGE 5 — One week of embryology laboratory procedures: The collected donor eggs are fertilized with the father candidate\'s sperm and the resulting embryos are cultured and monitored in our laboratory. This embryological phase takes approximately one week.\n\nSTAGE 6 — Embryo transfer and the pregnancy test on day 12: The treatment is completed with the transfer of the highest-quality embryo to the mother\'s uterus — a short, painless procedure. Twelve days after the transfer, a blood pregnancy test gives you the result.\n\nIf you are considering egg donation treatment, contact us via WhatsApp or phone. We will review your situation free of charge and prepare a personal treatment calendar for you.',
      tr: 'Bize ulaşan çiftlerin ilk sorusu genellikle şu oluyor: "Tam olarak neler yaşanacak ve ne zaman?" Aşağıda, Doğuş IVF Center\'da yumurta donasyonu tedavisinin altı aşamasını, gerçekte yaşandığı sırayla bulacaksınız — böylece hem tedavinizi hem de Kıbrıs seyahatinizi güvenle planlayabilirsiniz.\n\nAŞAMA 1 — Teşhisin konulması: Yumurta donasyonu tedavisinin başlangıç noktası, anne adayının yumurta rezervinin tükenmiş olduğuna dair teşhisin konulmasıdır. Bu, hormon testleri (AMH, FSH gibi) ve ultrason değerlendirmesi ile doğrulanır. Elinizde güncel tetkik sonuçları varsa, doktorlarımız siz Kıbrıs\'a gelmeden önce bunları uzaktan değerlendirebilir.\n\nAŞAMA 2 — Çiftin tetkikleri ve eş zamanlı donör seçimi: Anne ve baba adaylarının tetkik ve raporları tamamlanırken, eş zamanlı olarak donör havuzumuzdan size uygun donörün seçimi ve hazırlığı başlar. Donörler fiziksel özellikler ve kan grubuna göre eşleştirilir; her donör detaylı tıbbi ve genetik taramadan geçer. Bu iki adımın paralel yürütülmesi, toplam süreyi kısaltan en önemli etkendir.\n\nAŞAMA 3 — Rahmin hazırlanması ve donörün uyarılması: Bir taraftan anne adayının rahmi, kendi ülkesinde de uygulanabilen basit bir ilaç protokolüyle embriyo transferine hazır hale getirilir. Diğer taraftan seçilmiş donör gerekli tetkiklerden geçirilerek yumurta hücrelerinin gelişimi sağlanır.\n\nAŞAMA 4 — Başlama tarihinin belirlenmesi ve merkezimize davet: Her iki hazırlık eşzamanlı hale geldiğinde, işlemlerin kesin başlama tarihi belirlenir ve aile merkezimize davet edilir. Hastalarımızın çoğunun Kıbrıs\'ta fiziksel olarak bulunması yalnızca tedavinin bu son bölümü için gereklidir.\n\nAŞAMA 5 — Yaklaşık 1 hafta süren embriyolojik işlemler: Donörden toplanan yumurtalar baba adayının spermi ile döllenir; oluşan embriyolar laboratuvarımızda kültüre alınır ve yakından izlenir. Bu embriyolojik süreç yaklaşık bir hafta sürer.\n\nAŞAMA 6 — Embriyo transferi ve 12. günde gebelik testi: Tedavi, en kaliteli embriyonun anne adayının rahmine transferi ile sonlandırılır — kısa ve ağrısız bir işlemdir. Transferden 12 gün sonra yapılan kan testi ile gebelik sonucunuzu öğrenirsiniz.\n\nYumurta donasyonu tedavisini düşünüyorsanız WhatsApp veya telefon ile bize ulaşın; durumunuzu ücretsiz değerlendirip size özel bir tedavi takvimi hazırlayalım.',
      de: 'Viele Paare, die sich an uns wenden, haben eine Hauptfrage: "Was genau passiert — und wann?" Nachfolgend finden Sie die sechs Etappen der Eizellspende-Behandlung im Doğuş IVF Center in ihrer tatsächlichen Reihenfolge, damit Sie Ihre Behandlung und Ihre Reise nach Zypern sicher planen können.\n\nETAPPE 1 — Diagnosestellung: Ausgangspunkt der Behandlung ist die Feststellung, dass die Eizellreserve der Mutterkandidatin erschöpft ist. Dies wird durch Hormontests (z. B. AMH, FSH) und eine Ultraschalluntersuchung bestätigt. Aktuelle Befunde können unsere Ärzte bereits vor Ihrer Anreise aus der Ferne beurteilen.\n\nETAPPE 2 — Untersuchungen des Paares und gleichzeitige Spenderauswahl: Während die Mutter- und Vaterkandidaten ihre Untersuchungen und Berichte abschließen, beginnen wir parallel mit der Auswahl und Vorbereitung einer geeigneten Spenderin aus unserem Pool. Spenderinnen werden nach körperlichen Merkmalen und Blutgruppe zugeordnet und durchlaufen umfangreiche medizinische und genetische Tests. Diese Parallelität verkürzt die Gesamtdauer erheblich.\n\nETAPPE 3 — Vorbereitung der Gebärmutter und Stimulation der Spenderin: Einerseits wird die Gebärmutter der Mutterkandidatin mit einem einfachen Medikamentenprotokoll — auch im Heimatland durchführbar — auf den Embryotransfer vorbereitet. Andererseits absolviert die ausgewählte Spenderin ihre letzten Untersuchungen, und die Entwicklung ihrer Eizellen wird angeregt.\n\nETAPPE 4 — Festlegung des Starttermins und Einladung in unser Zentrum: Sobald beide Vorbereitungen synchron sind, wird der genaue Beginn der Eingriffe festgelegt und die Familie in unser Zentrum in Nikosia eingeladen. Die meisten Patienten müssen nur für diesen letzten Teil der Behandlung physisch auf Zypern sein.\n\nETAPPE 5 — Etwa eine Woche embryologischer Laborverfahren: Die entnommenen Spender-Eizellen werden mit dem Sperma des Vaterkandidaten befruchtet; die entstandenen Embryonen werden in unserem Labor kultiviert und überwacht. Diese embryologische Phase dauert etwa eine Woche.\n\nETAPPE 6 — Embryotransfer und Schwangerschaftstest am 12. Tag: Die Behandlung wird mit dem Transfer des qualitativ besten Embryos in die Gebärmutter abgeschlossen — ein kurzer, schmerzloser Eingriff. Zwölf Tage nach dem Transfer gibt ein Blut-Schwangerschaftstest das Ergebnis.\n\nWenn Sie eine Eizellspende-Behandlung in Erwägung ziehen, kontaktieren Sie uns per WhatsApp oder Telefon. Wir beurteilen Ihre Situation kostenlos und erstellen Ihren persönlichen Behandlungskalender.',
      ru: 'У большинства пар, которые обращаются к нам, один главный вопрос: «Что именно будет происходить и когда?» Ниже — шесть этапов лечения с донорскими яйцеклетками в Doğuş IVF Center в том порядке, в котором они происходят на самом деле, чтобы вы могли уверенно спланировать лечение и поездку на Кипр.\n\nЭТАП 1 — Постановка диагноза: Отправная точка лечения — медицинское заключение о том, что резерв яйцеклеток будущей матери исчерпан. Это подтверждается гормональными тестами (АМГ, ФСГ) и УЗИ. Если у вас уже есть свежие результаты анализов, наши врачи могут оценить их дистанционно до вашей поездки.\n\nЭТАП 2 — Обследование пары и одновременный подбор донора: Пока будущие мать и отец завершают анализы и получают заключения, мы параллельно начинаем подбор и подготовку подходящего донора из нашей базы. Доноры подбираются по внешним характеристикам и группе крови и проходят детальное медицинское и генетическое обследование. Именно параллельность этих шагов сокращает общий срок лечения.\n\nЭТАП 3 — Подготовка матки и стимуляция донора: С одной стороны, матка будущей матери готовится к переносу эмбриона по простому протоколу препаратов, который можно выполнять в своей стране. С другой стороны, выбранный донор проходит финальные обследования, и начинается стимуляция развития её яйцеклеток.\n\nЭТАП 4 — Назначение даты начала и приглашение в наш центр: Когда обе подготовки синхронизированы, назначается точная дата процедур, и семья приглашается в наш центр в Никосии. Большинству пациентов нужно физически находиться на Кипре только на этой финальной части лечения.\n\nЭТАП 5 — Около недели эмбриологических процедур: Полученные донорские яйцеклетки оплодотворяются спермой будущего отца; эмбрионы культивируются и наблюдаются в нашей лаборатории. Эта эмбриологическая фаза занимает примерно одну неделю.\n\nЭТАП 6 — Перенос эмбриона и тест на беременность на 12-й день: Лечение завершается переносом эмбриона наилучшего качества в матку — это короткая безболезненная процедура. Через 12 дней после переноса анализ крови покажет результат.\n\nЕсли вы рассматриваете лечение с донорскими яйцеклетками, свяжитесь с нами по WhatsApp или телефону — мы бесплатно оценим вашу ситуацию и составим персональный календарь лечения.',
      ar: 'السؤال الأول لدى معظم الأزواج الذين يتواصلون معنا هو: «ما الذي سيحدث بالضبط ومتى؟» فيما يلي المراحل الست لعلاج التبرع بالبويضات في مركز Doğuş لأطفال الأنابيب بالترتيب الفعلي، لتتمكنوا من التخطيط للعلاج ولرحلتكم إلى قبرص بثقة.\n\nالمرحلة 1 — تأكيد التشخيص: نقطة البداية هي التشخيص الطبي باستنفاد احتياطي البويضات لدى الأم المرشحة. يتم تأكيد ذلك بفحوصات هرمونية (مثل AMH وFSH) وتقييم بالموجات فوق الصوتية. إذا كانت لديكم نتائج فحوصات حديثة، يمكن لأطبائنا تقييمها عن بُعد قبل سفركم.\n\nالمرحلة 2 — فحوصات الزوجين واختيار المتبرعة في الوقت نفسه: بينما يُكمل الأم والأب المرشحان فحوصاتهما وتقاريرهما، نبدأ بالتوازي باختيار وتحضير المتبرعة المناسبة من قاعدة المتبرعات لدينا. تتم مطابقة المتبرعات حسب الصفات الجسدية وفصيلة الدم، وتخضع كل متبرعة لفحص طبي ووراثي شامل. هذا التوازي هو ما يجعل مدة العلاج قصيرة.\n\nالمرحلة 3 — تهيئة الرحم وتحفيز المتبرعة: من جهة، يتم تجهيز رحم الأم المرشحة لنقل الجنين ببروتوكول دوائي بسيط يمكن اتباعه في بلدها. ومن جهة أخرى، تُكمل المتبرعة المختارة فحوصاتها النهائية ويبدأ تحفيز نمو بويضاتها.\n\nالمرحلة 4 — تحديد تاريخ البدء ودعوتكم إلى مركزنا: عند تزامن التحضيرين، يُحدد التاريخ الدقيق لبدء الإجراءات وتُدعى العائلة إلى مركزنا في نيقوسيا. لا يحتاج معظم مرضانا إلى التواجد في قبرص إلا في هذا الجزء الأخير من العلاج.\n\nالمرحلة 5 — نحو أسبوع من إجراءات مختبر الأجنة: تُخصَّب بويضات المتبرعة بالحيوانات المنوية للأب المرشح، وتُزرع الأجنة الناتجة وتُراقب في مختبرنا. تستغرق هذه المرحلة نحو أسبوع واحد.\n\nالمرحلة 6 — نقل الجنين واختبار الحمل في اليوم الثاني عشر: يُختتم العلاج بنقل أفضل جنين إلى رحم الأم — إجراء قصير وغير مؤلم. بعد اثني عشر يومًا من النقل، يُظهر فحص الدم نتيجة الحمل.\n\nإذا كنتم تفكرون في علاج التبرع بالبويضات، تواصلوا معنا عبر واتساب أو الهاتف؛ سنقيّم حالتكم مجانًا ونعدّ لكم جدول علاج شخصيًا.'
    },
    date: '2026-08-08',
    category: {
      en: 'Egg Donation',
